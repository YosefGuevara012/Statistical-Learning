...
1.  crim: Vemos que la tasa de crimeness en todo Boston no supera el **90%**, y en algunos casos en cercana a **0%**, tambien se aprecia como el **96%** de los suburbios de Boston, posee una tasa inferior al **20%** de criminalidad.
2.  zn: Se aprecia que existen areas de de Boston que no poseen zonas residenciales por cada 25000 sq.ft, mientras otras se encuentran completamente llenas de areas residenciales siendo estas apenas el **2%**.
3.  indus: El rango nos muestra que el grado de areas industriales máximo por cada Acre en bostón es apenas el **28%**. No obstante el **32%** de estas areas esta industrializadas en alrededor del **18%**.
4.  chas: Esta en una variable logica donde se representa que si los distritos de boston conectan con el rio Charles vemos que apenas el **7%** de ellos no lo hacen.
5.  nox: xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
7.  age: Se aprecia que la proporcion de viviendas ocupadas por distrito que fueron construidas antes del 1940, se encuentra entre el **2** y el **100**, lo que parece ser un indicativo que grandes areas de la ciudad poseen edificios activos con más de 80 años de antiguedad para la fecha actual.
...
10. tax: Se evidencia que para ningun distrito la tas de impuesto por inmueble por cada **$1000 USD** es inferior a **$187 USD** y que en solo el **27%** de los suburbios es superior a **$600 USD**.
11. ptratio: Es claro que la tasa de profesores por alumno, no supera **22** alumnos por profesor es decir que se puede decir que en el peor de los casos los salones apenas superan la mitad de los estudiantes maximos por profesor en Bogotá.
12. black: xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
13. lstat: % lower status of the population
